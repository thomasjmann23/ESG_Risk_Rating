...
if page == "Dashboard Overview":
    ...
    if df is not None and model is not None:
        ...
        with chart_col2:
            st.markdown("#### Energy Efficiency Score Distribution")
            
            # Create histogram of actual energy efficiency scores
            ...
            fig_hist.update_layout(
                title="Distribution of Energy Efficiency Scores",
                xaxis_title="Energy Efficiency Score",
